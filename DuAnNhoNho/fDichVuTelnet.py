...
class dichVuTelnet(Toplevel):
    def __init__(self,**kwargs):
        ...
        heading = Label(heading_flame,text="Cài dịch vụ Telnet cho Server.",font="arial 17 bold",fg="black")
    ...
    def install_telnet_service(self):
