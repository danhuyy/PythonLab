...
sv6 = SinhVienChinhQuy(2004567, "Nguyễn Thành Nam", datetime.strptime("7/12/1999", "%d/%m/%Y"), 68)
sv7 = SinhVienPhiCQ(2004545, "Nguyễn Thanh Thanh", datetime.strptime("29/10/1999", "%d/%m/%Y"), "Trung cấp", 2.5)
sv8 = SinhVienChinhQuy (2004679, "Võ Hoài Nam", datetime.strptime("4/1/2009", "%d/%m/%Y"), 78)
dssv = DanhSachSv()
dssv.themSV(sv1)
dssv.themSV(sv2)
dssv.themSV(sv3)
...
# kq1 = dssv.timSvCDRLT80()
# for sv in kq1:
#     print(sv)

kq2 = dssv.timSvTDCDSTNgay()
for sv in kq2:
    print(sv)